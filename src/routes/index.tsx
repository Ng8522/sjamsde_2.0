...
import {
  FACEBOOK_EMBED_WIDTH,
  FACEBOOK_PAGE_URL,
  facebookPageEmbedUrl,
  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <div className="overflow-x-hidden">
              ...
              {community.map((c) => {
                return (
                  ...
                  >
                    ...
                    <h3 className="text-sm sm:text-base font-semibold text-foreground mb-1 leading-snug">
                      {c.title}
                    </h3>
        ...
        {/* Facebook */}
        <section className="relative py-12 md:py-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-primary/5 border-y border-primary/10">
          <div className="absolute inset-0 -z-10 pointer-events-none">
            <div className="absolute -top-32 right-0 w-[28rem] h-[28rem] bg-gradient-to-bl from-[#1877F2]/15 to-transparent rounded-full blur-3xl" />
            <div className="absolute -bottom-32 left-0 w-96 h-96 bg-gradient-to-tr from-primary/15 to-transparent rounded-full blur-3xl" />
          </div>
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-[minmax(0,1fr)_auto] gap-10 lg:gap-14 items-center">
              <div className="space-y-6 text-center lg:text-left">
                <span className="inline-flex items-center gap-2.5 text-primary font-semibold text-xs tracking-[0.3em] uppercase bg-gradient-to-r from-primary/15 to-secondary/10 px-6 py-3 rounded-full border border-primary/20">
                  <span className="size-2.5 rounded-full bg-gradient-to-r from-primary to-secondary" />
                  Stay connected
                </span>
                <div className="space-y-4">
                  <h2 className="text-3xl md:text-4xl font-semibold tracking-tight leading-tight">
                    ...
                    <span className="bg-gradient-to-r from-[#1877F2] to-primary bg-clip-text text-transparent">
                      Facebook
                    </span>
                  </h2>
                  <p className="text-base text-muted-foreground leading-relaxed max-w-xl lg:max-w-none">
                    Follow St. John Ambulance of Malaysia Selangor Darul Ehsan for event
                    announcements, training highlights, volunteer stories and field updates.
                  </p>
                </div>
                <ul className="flex flex-wrap justify-center lg:justify-start gap-3">
                  {["Event announcements", "Training highlights", "Volunteer stories"].map(
                    (item) => (
                      <li
                        key={item}
                        className="rounded-xl border border-primary/15 bg-white/80 px-4 py-2.5 text-sm text-muted-foreground shadow-sm"
                      >
                        <span className="flex items-center gap-2">
                          <span className="size-1.5 rounded-full bg-[#1877F2] shrink-0" />
                          {item}
                        </span>
                      </li>
                    ),
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2.5 min-h-11 px-6 bg-[#1877F2] text-white font-semibold rounded-xl hover:bg-[#166fe5] hover:shadow-xl hover:shadow-[#1877F2]/25 hover:-translate-y-0.5 transition-all"
                >
              ...
              <div
                className="w-full mx-auto lg:mx-0 lg:ml-auto shrink-0"
                style={{ maxWidth: FACEBOOK_EMBED_WIDTH }}
              >
                <div className="rounded-2xl border-2 border-primary/15 bg-white shadow-xl shadow-primary/10 overflow-hidden">
                  <iframe
                    title="SJAM Selangor on Facebook"
                    src={facebookPageEmbedUrl()}
                    className="w-full border-0 bg-white block"
                    style={{ width: FACEBOOK_EMBED_WIDTH, maxWidth: "100%", minHeight: 500 }}
                    scrolling="no"
