...
export const Route = createFileRoute("/payment")({
  ...
  head: () => ({
    meta: [
      { title: "Payment — SJAM Selangor" },
      {
        name: "description",
        content:
          "Secure your contribution for SJAM Selangor via FPX, DuitNow, or card in this mock payment page.",
      },
    ],
  }),
});
    ...
    <SiteLayout>
      <section className="bg-gradient-to-br from-primary/10 via-background to-secondary/10 border-b border-border">
        <div className="max-w-4xl mx-auto px-6 py-14 md:py-16">
          <span className="text-primary font-semibold text-xs tracking-[0.2em] uppercase">Payment</span>
          ...
          <p className="mt-6 text-muted-foreground leading-relaxed">
            This is a mock payment page for SJAM Selangor. Choose amount, payment method, and donor
            details to continue.
          </p>
        </div>
      </section>
