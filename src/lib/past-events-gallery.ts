...
export const pastEventAlbums: PastEventAlbum[] = [
  ...
  },
  {
    ...
    title: "2022 Mobile Clinic – Chik Sin Thong Old Folks Home Selangor",
    eventDate: "2022-11-01",
    dateLabel: "November 2022",
    location: "Pusat Jagaan Rumah Orang Tua Chik Sin Thong, Selangor",
    tag: "Mobile Clinic",
    summary: "Mobile medical clinic visit to Pusat Jagaan Rumah Orang Tua Chik Sin Thong, Selangor.",
    coverImage: "community",
    photoCount: 10,
  },
  {
