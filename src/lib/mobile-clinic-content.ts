/** Outreach Program copy for the Programs page. */
...
export const MOBILE_CLINIC = {
  ...
  intro: [
    "The SJAM Selangor Outreach Program is a community health outreach programme that takes medical care to the people who need it most. Our volunteer doctors, nurses and St John members deploy with outreach equipment to orphanages, old folks homes, welfare centres and remote communities.",
