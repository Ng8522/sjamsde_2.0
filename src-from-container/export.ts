...
import type { DonorRecord } from "./types.js";
...
function donorToXml(record: DonorRecord) {
...
function donorsDocument(donors: DonorRecord[]) {
...
export async function exportDonorsToFiles(donors: DonorRecord[]) {
  await ensureDataDir();
