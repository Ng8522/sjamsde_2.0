...
function excelDateToString(value: unknown) {
...
function rowToTransfer(row: RawRow, headers: string[]): ParsedTransfer | null {
...
async function readRowsFromFile(filePath: string): Promise<RawRow[]> {
...
export async function parseStatementFile(filePath: string): Promise<ParsedTransfer[]> {
